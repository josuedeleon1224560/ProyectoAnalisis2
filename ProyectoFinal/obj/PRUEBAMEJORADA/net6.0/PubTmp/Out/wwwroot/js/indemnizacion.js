...
function calcular_indemnizacion() {
    ...
    var valorLabel30 = document.getElementById("indemnizacion-total-sueldos").textContent;
    var valorLabel31 = document.getElementById("indemnizacion-total-comisiones").textContent;
    var valorLabel32 = document.getElementById("indemnizacion-total-horas-extra").textContent;
    var valorLabel33 = document.getElementById("indemnizacion-sub-total").textContent;
    var valorLabel34 = document.getElementById("indemnizacion-promedio").textContent;
    var valorLabel35 = document.getElementById("indemnizacion-a-recibir").textContent;

    document.getElementById("promedioSalario").value = valorLabel30;
    document.getElementById("Comisiones").value = valorLabel31;
    document.getElementById("HorasE").value = valorLabel32;
    document.getElementById("Subtotal").value = valorLabel33;
    document.getElementById("Promedio").value = valorLabel34;
    document.getElementById("Indemnizacion").value = valorLabel35;
