...
namespace ProyectoFinal.Migrations
{
    ...
    [Migration("20231026222500_implementando_mas_campos")]
    partial class implementando_mas_campos
    {
            ...
            modelBuilder.Entity("ProyectoFinal.Models.Nomina", b =>
                {
                    ...
                    b.HasIndex("AguinaldoNomina")
                        .IsUnique()
                        .HasFilter("[AguinaldoNomina] IS NOT NULL");

                    b.HasIndex("Bono14Nomina")
                        .IsUnique()
                        .HasFilter("[Bono14Nomina] IS NOT NULL");

                    b.HasIndex("CuotaPatronalNomina")
                        .IsUnique()
                        .HasFilter("[CuotaPatronalNomina] IS NOT NULL");
                    ...
                    b.HasIndex("VacacionesNomina")
                        .IsUnique()
                        .HasFilter("[VacacionesNomina] IS NOT NULL");
            ...
            modelBuilder.Entity("ProyectoFinal.Models.Nomina", b =>
                {
                    b.HasOne("ProyectoFinal.Models.Aguinaldo", "Aguinaldo")
                        .WithOne("Nomina")
                        .HasForeignKey("ProyectoFinal.Models.Nomina", "AguinaldoNomina");

                    b.HasOne("ProyectoFinal.Models.Bono14", "Bono14")
                        .WithOne("Nomina")
                        .HasForeignKey("ProyectoFinal.Models.Nomina", "Bono14Nomina");

                    b.HasOne("ProyectoFinal.Models.CuotaPatronal", "CuotaPAtronal")
                        .WithOne("Nomina")
                        .HasForeignKey("ProyectoFinal.Models.Nomina", "CuotaPatronalNomina");
                    ...
                    b.HasOne("ProyectoFinal.Models.Vacaciones", "Vacaciones")
                        .WithOne("Nomina")
                        .HasForeignKey("ProyectoFinal.Models.Nomina", "VacacionesNomina");
