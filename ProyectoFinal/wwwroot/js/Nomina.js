...
function calcularNomina() {
    ...
    /*var valorLabel16 = document.getElementById("total-salarios-anuales").textContent;*/
    //var valorLabel17 = document.getElementById("promedio-salarios-anuales").textContent;
    //var valorLabel18 = document.getElementById("total-comisiones-anuales").textContent;
    //var valorLabel19 = document.getElementById("promedio-comisiones-anuales").textContent;
    //var valorLabel20 = document.getElementById("salario-con-comisiones").textContent;
    //var valorLabel21 = document.getElementById("total-dias-trabajados-anuales").textContent;
    //var valorLabel22 = document.getElementById("total-bono-14").textContent;

    //var valorLabel23 = document.getElementById("total-de-dias-trabajados").textContent;
    //var valorLabel24 = document.getElementById("promedio-de-sueldos").textContent;
    //var valorLabel25 = document.getElementById("total-aguinaldo").textContent;

    //var valorLabel26 = document.getElementById("total-ordinary-salary").textContent;
    //var valorLabel27 = document.getElementById("total-comisions-calc").textContent;
    ...
    document.getElementById("Bono14Salarios").value = valorLabel16;
    //document.getElementById("Bono14PromedioSalarios").value = valorLabel17;
    //document.getElementById("Bono14TotalComisiones").value = valorLabel18;
    //document.getElementById("Bono14PromedioComisiones").value = valorLabel19;
    //document.getElementById("Bono14SalarioMasComisiones").value = valorLabel20;
    //document.getElementById("Bono14DiasLaborados").value = valorLabel21;
    //document.getElementById("Bono14Total").value = valorLabel22;

    //document.getElementById("AguinaldoDias").value = valorLabel23;
    //document.getElementById("AguinaldoPromedio").value = valorLabel24;
    //document.getElementById("AguinaldoTotal").value = valorLabel25;

    //document.getElementById("VacaSueldos").value = valorLabel26;
    //document.getElementById("VacaComi").value = valorLabel27;
    //document.getElementById("VacaHoras").value = valorLabel28;
    //document.getElementById("VacaResultado").value = valorLabel29;
